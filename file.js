...
module.exports = {
  ...
  onStart: async function ({ args, message }) {
    ...
    if (!fileName || !text) {
      return message.reply("use:fs hi.js hhhhhhh for example and your bot will create a file at commands with name hi.js and he put inside hhhhhhhhhh (example) recommended to create commands from caht - MODED BY XyryllPanget DON'T change or i I don't share my commands again 😐");
    }

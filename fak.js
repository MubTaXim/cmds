...
module.exports = {
    ...
    onStart: async function ({ message, event, args }) {
        ...
        if (mention.length == 0) return message.reply("Please mention someone:<@tag> or <@tag1 @tag2>");
...
async function bal(one, two) {
    ...
    avtwo.circle()
    let pth = "fak.png"
    let img = await jimp.read("https://i.postimg.cc/26zjWNRR/fak.png")

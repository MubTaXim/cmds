...
module.exports = {
  ...
  onStart: async function ({ message, args }) {
    ...
    message.reply("⏱ Generating your imagination. Please wait ...").then((info) => {
      id = info.messageID;  
    });

    try {
			const API = `https://imagine.bxo1.repl.co/imagine?model=${model}&prompt=${encodeURIComponent(prompt)}`;
